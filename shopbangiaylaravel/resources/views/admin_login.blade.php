...
<body class="bg-gradient-primary">
  ...
  ?>
                  <form action="{{URL::to('/admin-dashboard')}}" method="post" class="user">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." name="admin_email">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password" name="admin_password">
                    </div>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{URL::to('/register-auth')}}">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
