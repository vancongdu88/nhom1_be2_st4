...
<!-- Mirrored from demo.devitems.com/raavin-v3/raavin/login-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jun 2020 15:14:57 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>My Account || Raavin - Shoes eCommerce Bootstrap 4 Template</title>
                                                ...
                                                <li><a href="#"><i class="fa fa-cog"></i>Setting</a>
                                                    <ul class="dropdown primary-dropdown">
                                                        ...
                                                        <li class="other-style"><a href="#"><i class="fa fa-language"></i>Language</a>
                                                            ...
                                                            <ul class="primary-dropdown language-dropdown">
